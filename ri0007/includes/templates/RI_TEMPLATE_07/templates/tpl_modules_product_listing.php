...
?>
<div class="buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_ADD_PRODUCTS_TO_CART, BUTTON_ADD_PRODUCTS_TO_CART_ALT, 'class="submit2" name="submit1"'); ?></div>
<br class="clearBoth" />
<?php
...
<?php }
//if ($this_is_home_page && isset($is_index_listing) && $is_index_listing) 
